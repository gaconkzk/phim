...
app.get('/api/search', publicApi, ctrl.search.search)
// app.get('/watch', ctrl.home.watch)
app.get('/api/info', publicApi, ctrl.home.info)
app.get('/api/search', publicApi, ctrl.home.handleApi)
app.get('/api/movies/:url/list.m3u8', publicApi, ctrl.home.watchmovie)
app.get('/api/movies/:url/:segment', publicApi, ctrl.home.segment)

app.get('/api/types', publicApi, ctrl.search.types)
module.exports = app
