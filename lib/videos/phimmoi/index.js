...
const updateMediaUrl = (res) => {
  ...
  url = `http://${process.env.HOST}:${process.env.PORT}/api/movies/${Buffer.from(aes.enc(JSON.stringify({ url, referer: json.referer }), process.env.SECRET)).toString('base64')}/list.m3u8`
