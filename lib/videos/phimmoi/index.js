...
const updateMediaUrl = (res) => {
  ...
  url = `http://${process.env.SERVER_HOST}:${process.env.SERVER_PORT}/api/movies/${Buffer.from(aes.enc(JSON.stringify({ url, referer: json.referer }), process.env.SECRET)).toString('base64')}/list.m3u8`
