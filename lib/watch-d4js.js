var Watching = function () {
    ...
    var _0x83dfx6 = null;
    var _0x83dfx7 = "";
    var _0x83dfx8 = function (_0x83dfx9) {
        if (typeof _0x83dfx9.medias == "object" && _0x83dfx9.medias.length > 0) {
            var _0x83dfxa = "PhimMoi.Net@" + _0x83dfx9.episodeId;
            if (_0x83dfx7) {
                var _0x83dfxb = _0x83dfx7
            } else {
                var _0x83dfxb = ((typeof KEY_MEDIA_URL == "string") ? KEY_MEDIA_URL : "") + _0x83dfx9.episodeId
            };
            for (var _0x83dfxc in _0x83dfx9.medias) {
                if (typeof _0x83dfx9.medias[_0x83dfxc].url == "string" && _0x83dfx9.medias[_0x83dfxc].url.indexOf("://") == -1) {
                    var _0x83dfxd = _0x83dfx9.medias[_0x83dfxc].url;
                    try {
                        _0x83dfx9.medias[_0x83dfxc].url = GibberishAES.dec(_0x83dfxd, _0x83dfxa)
                    } catch (err) {};
                    if (_0x83dfx9.medias[_0x83dfxc].url.indexOf("://") == -1) {
                        try {
                            _0x83dfx9.medias[_0x83dfxc].url = GibberishAES.dec(_0x83dfxd, _0x83dfxb)
                        } catch (err) {}
                    }
                }
            }
    ...
    this.setCurrentEpisode = function (_0x83dfx11) {
        _0x83dfx6 = _0x83dfx11
    };
    ...
    this.autoReport = function () {
        try {
            ...
            if (_0x83dfx23.indexOf(_0x83dfx6.episodeId) != -1) {
                return false
            };
            var _0x83dfx25 = "autoreport.php/\?_fxAjax=1";
            var _0x83dfx26 = {
                'episodeId': _0x83dfx6.episodeId,
                'episodeNumber': _0x83dfx6.number,
                'episodePart': _0x83dfx6.part,
                'encodedUrl': _0x83dfx6.url,
                'filmId': filmInfo.filmId
            };
            _0x83dfx23.push(_0x83dfx6.episodeId);
            jQuery.ajax({
                'url': _0x83dfx25,
                'method': "POST",
                'data': _0x83dfx26,
    ...
    this.isUseAutoNext = function () {
        if (!filmInfo.isSeries && !_0x83dfx6.part) {
            return false
        };
        if (_0x83dfx29) {
            return true
    ...
    this.isFinalEpisode = function () {
        if (_0x83dfx2b == _0x83dfx6.episodeId && _0x83dfx2c != -1) {
            return _0x83dfx2c
        };
        ...
        _0x83dfx2b = _0x83dfx6.episodeId;
    ...
    this.getNextEpisodeElem = function () {
        var _0x83dfx2d = null;
        try {
            var _0x83dfx2e = _0x83dfx6.episodeId;
    ...
    this.displayAutoNextMessage = function (_0x83dfx37) {
        ...
        if (_0x83dfx33 == _0x83dfx6.episodeId) {
            return false
        };
    ...
    this.hideAutoNextMessage = function () {
        _0x83dfx33 = _0x83dfx6.episodeId;
    ...
    this.rememberEpisode = function () {
        try {
            ...
            var _0x83dfx3a = JSON.stringify({
                'number': _0x83dfx6.number,
                'part': _0x83dfx6.part,
                'language': _0x83dfx6.language,
                'edition': _0x83dfx6.edition
            });
    ...
    this.loadRemember = function (_0x83dfx4f) {
        try {
            ...
            if (_0x83dfx54.episodeId == _0x83dfx6.episodeId) {
                if (_0x83dfx4f > 60) {
...
//         return false
    ...
    this.handleData = function (_0x83dfx9) {
        jQuery("#media-player #player-embed").remove();
        if (typeof _0x83dfx9 == "object") {
            window.lastEpisodeData = _0x83dfx9
        };
        this.cancelReloadTimer();
        this.initNoticeBox();
        var _0x83dfx66 = this.getRequestId();
        if (typeof _0x83dfx9.requestId != "undefined" && _0x83dfx9.requestId && _0x83dfx9.requestId != _0x83dfx66) {
            console.warn("requestId không khớp! " + _0x83dfx66 + "!=" + _0x83dfx9.requestId);
            return false
        };
        if (typeof _0x83dfx9 != "object") {
        ...
        if (typeof _0x83dfx9.reload != "undefined" && _0x83dfx9.reload) {
            if (typeof _0x83dfx9.reloadUrl == "string" && _0x83dfx9.reloadUrl != "") {
                fx.displayMessage("Chuẩn bị chuyển trang...");
                setTimeout(function () {
                    window.location.replace(_0x83dfx9.reloadUrl)
                }, 2000)
            } else {
        ...
        _0x83dfx9 = _0x83dfx8(_0x83dfx9);
        var _0x83dfx67 = this.getPlaylist(_0x83dfx9);
        if (!_0x83dfx67) {
            console.error("Không tạo được playlist");
            return false
        };
        if (typeof _0x83dfx9.original == "string") {
            this.setBackupFile(_0x83dfx9.original)
        } else {
            this.setBackupFile("")
        };
        _0x83dfx6 = _0x83dfx9;
        try {
            if (typeof _0x83dfx9.medias == "object" && _0x83dfx9.medias.length > 0) {
                if (_0x83dfx9.medias[0].url.indexOf("googleapis.com") != -1) {
                    this.trackEvent("Stream Server", "Google Storage", filmInfo.title)
                } else {
                    if (_0x83dfx9.medias[0].url.indexOf("googleusercontent.com") != -1) {
                        this.trackEvent("Stream Server", "Google User Content", filmInfo.title)
                    } else {
                        if (_0x83dfx9.medias[0].url.indexOf("googlevideo.com") != -1) {
                            this.trackEvent("Stream Server", "Google Video", filmInfo.title)
                        } else {
                            if (_0x83dfx9.medias[0].url.indexOf("google") != -1) {
                                this.trackEvent("Stream Server", "Other Google Server", filmInfo.title)
                            } else {
                                if (_0x83dfx9.medias[0].url.indexOf(".phimmoi.net/s") != -1) {
        ...
        if (!_0x83dfx4) {
            _0x83dfx3.setPlaylist(_0x83dfx67);
            ...
            _0x83dfx3.load(_0x83dfx67)
        };
        try {
            if (typeof _0x83dfx9.notice == "object" && _0x83dfx9.notice && _0x83dfx9.notice.length > 0) {
                var _0x83dfx69 = "\+ ";
                if (_0x83dfx9.notice.length == 1) {
                    _0x83dfx69 = ""
                };
                for (var _0x83dfxc in _0x83dfx9.notice) {
                    var _0x83dfx6a = _0x83dfx69 + _0x83dfx9.notice[_0x83dfxc] + ((_0x83dfx69 != "") ? "<br>" : "");
        ...
        this.trackEvent("episodeView", "onPage", _0x83dfx9.episodeId);
        if (typeof window.thirdPartyStorageHandle == "function") {
            try {
                window.thirdPartyStorageHandle(_0x83dfx9)
            } catch (err) {}
        };
        try {
            if (document.cookie.indexOf("test_new") == -1) {};
            if (typeof _0x83dfx9.thirdParty == "object" && _0x83dfx9.thirdParty.length > 0) {
                ...
                for (var _0x83dfx6b in _0x83dfx9.thirdParty) {
                    var _0x83dfx6c = _0x83dfx9.thirdParty[_0x83dfx6b];
        ...
        try {
            if (typeof window.handleDataCompleteCallback == "function") {
                window.handleDataCompleteCallback(_0x83dfx9)
            } else {
    ...
    this.changeEpisode = function (_0x83dfx28, _0x83dfx74) {
        try {
            ...
            if (typeof _0x83dfx7 == "string" && _0x83dfx7 != "") {
                _0x83dfx79.decryptkey = _0x83dfx7
            };
    ...
    this.getPlaylist = function (_0x83dfx11) {
        if (typeof _0x83dfx11.original == "string") {
            var _0x83dfx7e = this.getCustomFlag("googleVideoOk");
            var _0x83dfx7f = this.getCustomFlag("originalFileOk");
            var _0x83dfx80 = _0x83dfx11.original;
        ...
        if (typeof _0x83dfx11.medias == "object" && (typeof _0x83dfx11.medias.video == "object" || (typeof _0x83dfx11.medias.length == "number" && _0x83dfx11.medias.length > 0))) {
            var _0x83dfx82 = [];
            var _0x83dfx83 = "";
            var _0x83dfx84 = [];
            if (typeof _0x83dfx11.medias.audio == "string" && _0x83dfx11.medias.audio != "") {
                _0x83dfx83 = _0x83dfx11.medias.audio
            };
            if (typeof _0x83dfx11.medias.video == "object") {
                _0x83dfx84 = _0x83dfx11.medias.video
            } else {
                _0x83dfx84 = _0x83dfx11.medias
            };
            ...
            if (typeof _0x83dfx11.url == "string" && _0x83dfx11.url != "") {
                var _0x83dfx87 = "/player.php\?url=" + encodeURIComponent(_0x83dfx11.url) + _0x83dfx81;
                var _0x83dfx88 = "/player.php\?url=" + encodeURIComponent(_0x83dfx11.url) + _0x83dfx81 + "&res=720";
                var _0x83dfx67 = [{
                    'sources': [{
                        'file': _0x83dfx87,
                        'label': "360p",
        ...
        if (typeof _0x83dfx11.vttUrl == "string" && _0x83dfx11.vttUrl != "") {
            _0x83dfx67[0].tracks = [{
                'file': _0x83dfx11.vttUrl,
                'kind': "subtitles",
                'label': "Vietsub",
                'default': true
            }]
        ...
        if (typeof filmInfo.previewUrl == "string" && filmInfo.previewUrl != "") {
            _0x83dfx67[0].image = filmInfo.previewUrl
        };
        if (typeof _0x83dfx11.number == "undefined" && typeof _0x83dfx11.episodeNumber != "undefined") {
            _0x83dfx11.number = _0x83dfx11.episodeNumber
        };
        if (typeof _0x83dfx11.part == "undefined" && typeof _0x83dfx11.episodePart != "undefined") {
            _0x83dfx11.part = _0x83dfx11.episodePart
        };
        if (typeof filmInfo.title == "string" && filmInfo.title != "") {
            _0x83dfx67[0].title = filmInfo.title;
            if (typeof _0x83dfx11.number == "number") {
                _0x83dfx67[0].description = "";
                if (typeof _0x83dfx11.edition == "string" && _0x83dfx11.edition != "") {
                    var _0x83dfx89 = {
                    ...
                    var _0x83dfx8a = _0x83dfx11.edition;
                    if (typeof _0x83dfx89[_0x83dfx8a] != "undefined") {
                        _0x83dfx67[0].description += _0x83dfx89[_0x83dfx8a]
                    }
                };
                if (filmInfo.isSeries) {
                    if (_0x83dfx11.number > 0) {
                        if (_0x83dfx67[0].description != "") {
                            _0x83dfx67[0].description += " - "
                        };
                        _0x83dfx67[0].description += "Tập " + _0x83dfx11.number;
                        if (typeof _0x83dfx11.part == "number" && _0x83dfx11.part > 0) {
                            _0x83dfx67[0].description += "." + _0x83dfx11.part
                        }
                    }
                } else {
                    if (typeof _0x83dfx11.part == "number" && _0x83dfx11.part > 0) {
                        ...
                        _0x83dfx67[0].description += "Part " + _0x83dfx11.part
                    }
                };
                if (typeof _0x83dfx11.language == "string" && _0x83dfx11.language != "") {
                    var _0x83dfx8b = {
                        'subtitle': "Vietsub",
                    ...
                    var _0x83dfx8c = _0x83dfx11.language;
                    if (typeof _0x83dfx8b[_0x83dfx8c] != "undefined") {
                        _0x83dfx67[0].description += " \(" + _0x83dfx8b[_0x83dfx8c] + "\)"
                    }
                }
            };
            _0x83dfx67[0].trackTitle = _0x83dfx67[0].title + " / " + _0x83dfx67[0].description;
            _0x83dfx67[0].trackLabel = _0x83dfx67[0].title
        };
        return _0x83dfx67
    };
    var _0x83dfx8d = 0;
        ...
        try {
            ...
            _0x83dfx3.on("firstFrame", function (_0x83dfx8f) {
                try {
                    ...
                    var _0x83dfx67 = this.getPlaylist();
                    if (_0x83dfx67.length > 0) {
                        if (typeof _0x83dfx67[0].trackTitle == "string") {
                            _0x83dfx21 = _0x83dfx67[0].trackTitle
                        } else {
                            if (typeof _0x83dfx67[0].title == "string") {
                                _0x83dfx21 = _0x83dfx67[0].title
                            }
                        }
                    };
    ...
    this.increaseErrorCount = function () {
        if (_0x83dfxc8.episodeId == _0x83dfx6.episodeId) {
            _0x83dfxc8.errorCount++
        } else {
            _0x83dfxc8.episodeId = _0x83dfx6.episodeId;
    ...
    this.getBackupLink = function () {
        var _0x83dfxc9 = jQuery('a.btn-episode\[data-episodeid!="' + _0x83dfx6.episodeId + '"\]\[data-number="' + _0x83dfx6.number + '"\]\[data-part="' + _0x83dfx6.part + '"\]');
        if (_0x83dfxc9.length == 0) {
            if (_0x83dfx6.part != 0) {
                _0x83dfxc9 = jQuery('a.btn-episode\[data-episodeid!="' + _0x83dfx6.episodeId + '"\]\[data-number="' + _0x83dfx6.number + '"\]\[data-part="0"\]')
            } else {
                _0x83dfxc9 = jQuery('a.btn-episode\[data-episodeid!="' + _0x83dfx6.episodeId + '"\]\[data-number="' + _0x83dfx6.number + '"\]\[data-part="1"\]')
            }
        };
        if (_0x83dfxc9.length > 0) {
            return _0x83dfxc9
    ...
    this.retryUpdateLink = function (_0x83dfxcc) {
        try {
            ...
            if (!_0x83dfxcc && _0x83dfxca == _0x83dfx6.episodeId) {
                return false
            };
            ...
            try {
                ...
                var _0x83dfx67 = this.getPlayer().getPlaylist();
                var _0x83dfxd0 = "";
                if (_0x83dfx67.length > 0 && typeof _0x83dfx67[0] == "object" && typeof _0x83dfx67[0].sources[0].file == "string") {
                    var _0x83dfxd1 = this.parseUrl(_0x83dfx67[0].sources[0].file);
                    if (typeof _0x83dfxd1 == "object" && typeof _0x83dfxd1.hostname == "string") {
                        _0x83dfxd0 = _0x83dfxd1.hostname
                    } else {
                        _0x83dfxd0 = _0x83dfx67[0].sources[0].file
                    };
            ...
            if (jQuery("a.btn-episode.active").length > 0) {
                ...
                jQuery(_0x83dfxd2).attr("data-episodeid", _0x83dfx6.episodeId);
                jQuery(_0x83dfxd2).attr("data-number", _0x83dfx6.number);
                jQuery(_0x83dfxd2).attr("data-part", _0x83dfx6.part);
                jQuery(_0x83dfxd2).attr("data-language", _0x83dfx6.language)
            };
    ...
    this.playerErrorCallback = function (_0x83dfx8f) {
        ...
        try {
            ...
            if (typeof window.lastEpisodeData == "object" && typeof window.lastEpisodeData.embedUrls == "object" && window.lastEpisodeData.embedUrls.length > 0) {
                ...
                if (_0x83dfx6d.indexOf("://") == -1 && _0x83dfx7 != "") {
                    _0x83dfx6d = GibberishAES.dec(_0x83dfx6d, _0x83dfx7)
                };
                if (_0x83dfx6d.indexOf("#") == -1) {
                    _0x83dfx6d += "#"
                };
